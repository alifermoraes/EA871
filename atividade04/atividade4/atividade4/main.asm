...
MAIN:
    /* Define o valore de R25:R24 para simular o parâmetro que será passado pelo programa em C (500) */
    LDI PRMLO, 0xF4
    LDI PRMHI, 0x01

    /* Seta o pino 5 do portb como saída */
    LDI BMASK, 0x20
    OUT DDRB, BMASK
...
DELAY:
     ...
     * Número total de ciclos da rotina implementada: 3 * R17 + 770 * R18 - 769
     * R17 = 198 e R18 = 21 => 15995 ciclos + 2 ciclos de LDI = 15997 ciclos.
     */
